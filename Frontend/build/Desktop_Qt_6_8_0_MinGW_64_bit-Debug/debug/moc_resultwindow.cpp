...
struct qt_meta_stringdata_CLASSresultwindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSresultwindowENDCLASS = QtMocHelpers::stringData(
    "resultwindow",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSresultwindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject resultwindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSresultwindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSresultwindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSresultwindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *resultwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSresultwindowENDCLASS.stringdata0))
